...
#ifndef __xmlccDomViewer_h__
#define __xmlccDomViewer_h__
...
#define _XMLCC_VERSION_DOM_Viewer_ 0.71 // 20100430
#define _XMLCC_DEBUG_DOM_Viewer_
...
Viewer {
 public:
  ...
  Viewer( void ); /// constructor
  virtual ~Viewer( void ); /// destructor

  void view( Object* obj ); /// print object tree to std::cout
